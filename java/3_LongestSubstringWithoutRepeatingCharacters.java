...
public class Solution {
    public int lengthOfLongestSubstring(String s) {
        ...
        /* Logic is to use two pointer approach(sliding window) that will hold only unique characters. 
		   While going through each character, see if character is seen for first time, if yes then move right pointer ahead, 
